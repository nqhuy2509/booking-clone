...
export default function SelectionHotel() {
  return (
    <div>
      <div className="flex w-[1024px] h-[350px] bg-gray-200 rounded-lg	mt-4 ">
        <div className="w-60 h-80 pt-7 ml-5">
          <Image src="/image/523031462.webp" />
        </div>
        <div className="mt-8">
          <div className="ml-4 flex">
            <h1 className="font-bold text-2xl text-[#006ce4]">
              KHÁNH AN HOTEL
            </h1>
          ...
          <div className="flex pl-4 text-[#006ce4] font-semibold pt-4">
            <a href="">Xuan Huong Lake, DaLat</a>
          ...
          <div>
            ...
            <div className="car pl-[500px] mt-0">
              <h1 className="text-black font-bold pl-8 text-xl pb-3">
                VND 597,087
              </h1>
