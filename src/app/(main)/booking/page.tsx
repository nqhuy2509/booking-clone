...
import { Button, Calendar, CalendarDate, DateInput, DatePicker } from '@nextui-org/react'
...
const BookingPage = () => {
	...
	const [checkOutDate, setCheckOutDate] = useState(today(getLocalTimeZone()).add({ days: 1 }))
